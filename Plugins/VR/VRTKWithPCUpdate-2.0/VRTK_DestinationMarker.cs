...
namespace VRTK
{
    ...
    public abstract class VRTK_DestinationMarker : MonoBehaviour
    {
        ...
        /// </summary>
        public event DestinationMarkerEventHandler InteractableObjectUsed;
        /// <summary>
        ...
        {
            if (InteractableObjectUsed != null && (!forceHoverOnRepeatedEnter || (e.raycastHit.collider != existingCollider)))
            {
