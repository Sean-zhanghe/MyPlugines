...
namespace VRTK
{
    ...
    public class VRTK_InteractTouch : MonoBehaviour
    {
        ...
        {
            OnTriggerEnterCover(collider);
        }

        protected virtual void OnTriggerExit(Collider collider)
        {
            OnTriggerExitCover(collider);
        }

        protected virtual void OnTriggerStay(Collider collider)
        {
            OnTriggerStayCover(collider);
        }

        public void OnTriggerEnterCover(Collider collider)
        {
        ...
        public void OnTriggerExitCover(Collider collider) { touchedObjectActiveColliders.Remove(collider); }
        public void OnTriggerStayCover(Collider collider)
        {
            GameObject colliderInteractableObject = TriggerStart(collider);
